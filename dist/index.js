...
import { toolDefinitions, handlePreviewPost, handlePublishPost, handleListPosts, handleDeletePost, } from "./tools.js";
const server = new Server({ name: "mcp-blog", version: "0.1.0" }, { capabilities: { tools: {} } });
// ツール一覧を返す
